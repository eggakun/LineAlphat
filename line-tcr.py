...
cl = LINETCR.LINE() //Admin
cl.login(qr=True)

ki = LINETCR.LINE() //Guard1
ki.login(qr=True)

kk = LINETCR.LINE() // Guard2
kk.login(qr=True)

kc = LINETCR.LINE() //Guard3
kc.login(qr=True)

ks = LINETCR.LINE() //Guard4
ks.login(qr=True)

ka = LINETCR.LINE() //Guard5
ka.login(qr=True)
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"u33d60593ad472ed11e7907fb1daee6ae"]
